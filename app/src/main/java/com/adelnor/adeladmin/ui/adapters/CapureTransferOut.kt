...
class CapureTransferOut(
    private val exampleList: List<DeapTransferItemPost>
) :
    RecyclerView.Adapter<CapureTransferOut.ExampleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ExampleViewHolder, position: Int) {
        ...
        holder.textView0.text = currentItem.codProd.toString()
        holder.textView1.text = currentItem.quantity.toString()
        holder.textView2.text = currentItem.description
        holder.textView3.text = currentItem.niDQR.toString()
    }
    ...
    inner class ExampleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        override fun onClick(v: View?) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                ...
                tools.getDeapTransferItem(currentItem, v!!.context)
            }
        }
    }
