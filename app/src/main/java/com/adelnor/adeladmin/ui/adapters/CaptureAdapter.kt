...
class CaptureAdapter(private var listener: ItemSelectedListener)
    : RecyclerView.Adapter<CaptureAdapter.CaptureViewHolder>(){

    var items: RealmResults<ItemExtended>? = null
        set(value) {
            field = value
    ...
    class CaptureViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        fun bind(item: ItemExtended, listener: ItemSelectedListener){
