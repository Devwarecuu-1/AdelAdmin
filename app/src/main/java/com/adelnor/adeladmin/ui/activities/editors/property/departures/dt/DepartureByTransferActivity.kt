...
class DepartureByTransferActivity : AppCompatActivity() {
    private lateinit var viewModel: DepartureByTransferViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = DepartureByTransferViewModel()
        setContentView(R.layout.activity_departure_by_transfer)
